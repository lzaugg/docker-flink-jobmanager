...
ENV FLINK_VERSION 1.1.1_akka-2.4.9
...
RUN curl https://s3.eu-central-1.amazonaws.com/flink-1.1.1-akka-2.4.9/flink-1.1.1_akka-2.4.9.tar.gz  | tar -C /opt/ -xz | ln -s /opt/flink-${FLINK_VERSION}/ ${FLINK_HOME}
